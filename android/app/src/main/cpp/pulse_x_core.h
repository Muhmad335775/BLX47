...
/* Paper 6 - PULSE-X CINEMATIC RENDERER API.
 * px_core_build_cinematic_render: valid during RENDER state only,
 * after begin_render, and requires both a generated world
 * (px_core_generate_world) and a generated voice scene
 * (px_core_generate_voice_scene) from this take. device_tier is
 * 0=low, 1=mid, 2=high per PxDeviceTier. */
