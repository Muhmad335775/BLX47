...
/* Paper 5 - PULSE-X VOICE SCENE ENGINE API.
 * px_core_get_live_voice_scene: valid during RECORDING only -
 * satisfies Live Sync (reacts while the recording is held).
 * px_core_generate_voice_scene / px_core_get_voice_scene: valid
 * during GENERATION only, after end_recording. device_tier is
