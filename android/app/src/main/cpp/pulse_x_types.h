...
/* Fixed data contracts shared across all PULSE-X CORE states.
 * Every struct is fixed-size and contains no heap pointers,
 * so it can be pre-allocated once at INITIALIZE and reused
